...
- [x] 2.5 `integration-tests` appears as a separate parallel job and goes green in the Actions tab — user-confirmed, PR #30 run 33310288313 — 3d3e6b0
- [x] 2.6 Added wall-clock is in the expected ~2-4 min range — 3m10s, user-confirmed — 3d3e6b0
